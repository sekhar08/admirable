...
import { Agent, createAgent, anthropic, createTool, createNetwork, type Tool } from "@inngest/agent-kit";
        ...
        const codeAgent = createAgent<AgentState>({
            ...
            tools: [
                ...
                createTool({
                    ...
                    handler: async (params: any, { step, network }: Tool.Options<AgentState>) => {
